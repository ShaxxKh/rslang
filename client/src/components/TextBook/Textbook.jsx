      ...
      setData(result.data.map((elem, index) => (
        <div key={elem.id}>
          <ListItem component="div">
            <ListItemIcon><div className={styles.image} style={{ backgroundImage: 'url("https://raw.githubusercontent.com/arcanar7/rslang-data/master/files/01_0001.jpg")' }} /></ListItemIcon>
